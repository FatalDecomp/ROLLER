...
fn configureWebBuild(b: *Build, optimize: OptimizeMode) void {
    ...
    run_emcc.addArgs(&.{
        ...
        "-lidbfs.js",
        "-sINVOKE_RUN=0",
        "-sEXPORTED_FUNCTIONS=_main,_ROLLERWebExtractFATDATA,_ROLLERWebSetPhoneMode,_ROLLERWebSetAccel,_ROLLERWebSetPhoneControls,_ROLLERWebGetPhoneControls,_ROLLERWebSetWindowSize",
