...
// Only implemented gameplay-3D command kinds are named here. Legacy priorities
// stay on the temporary compatibility path until their renderers migrate to
// typed queue submission APIs.
typedef enum {
...
// Temporary compatibility API for unmigrated legacy render priorities.
// Priorities with named command APIs must use those APIs instead.
