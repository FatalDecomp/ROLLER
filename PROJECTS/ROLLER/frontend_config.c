  ...
  while (2) {
    ...
    if (iMenuSelection >= 7) {
      ...
      menu_render_text(mr, 2, "~", font2_ascii, font2_offsets,
                       sel_posns[iMenuSelection].x, sel_posns[iMenuSelection].y,
                       0x8Fu, 0, pal_addr);
    }

    // menu options labels
    menu_render_text(mr, 2, &config_buffer[3968], font2_ascii, font2_offsets,
                     sel_posns[0].x + 132, sel_posns[0].y + 7, 0x8Fu, 2u,
                     pal_addr);
    menu_render_text(mr, 2, &config_buffer[256], font2_ascii, font2_offsets,
                     sel_posns[1].x + 132, sel_posns[1].y + 7, 0x8Fu, 2u,
                     pal_addr);
    menu_render_text(mr, 2, &config_buffer[1664], font2_ascii, font2_offsets,
                     sel_posns[2].x + 132, sel_posns[2].y + 7, 0x8Fu, 2u,
                     pal_addr);
    menu_render_text(mr, 2, &config_buffer[4032], font2_ascii, font2_offsets,
                     sel_posns[3].x + 132, sel_posns[3].y + 7, 0x8Fu, 2u,
                     pal_addr);
    menu_render_text(mr, 2, &config_buffer[4096], font2_ascii, font2_offsets,
                     sel_posns[4].x + 132, sel_posns[4].y + 7, 0x8Fu, 2u,
                     pal_addr);
    menu_render_text(mr, 2, &config_buffer[4160], font2_ascii, font2_offsets,
                     sel_posns[5].x + 132, sel_posns[5].y + 7, 0x8Fu, 2u,
                     pal_addr);

    // network option if enabled
    if (network_on)
      menu_render_text(mr, 2, &config_buffer[5568], font2_ascii, font2_offsets,
    ...
    case 0:
      ...
      do {
        ...
        if ((iCarLoop & 1) >= allocated_cars[iCarDisplay / 2]) {
          ...
          if (iCarIndex == iSelectedCar && iEditingName == 1) {
            ...
            menu_render_text(mr, 15, szCarName, font1_ascii, font1_offsets, 425,
                             iTextPosY, iNormalColor, 2u, pal_addr);
            if (iCarIndex == iSelectedCar)
              byTextColor3 = iHighlightColor;
            else
              byTextColor3 = 0x8F;
            menu_render_text(mr, 15, szNewNameBuf, font1_ascii, font1_offsets,
                             430, iTextPosY, byTextColor3, 0, pal_addr);
          } else {
            ...
            if (iCarIndex == iSelectedCar)
              ...
              byTextColor4 = 0x8F;
            menu_render_text(mr, 15, szCarName, font1_ascii, font1_offsets, 425,
                             iTextPosY, byTextColor4, 2u, pal_addr);
            if (iCarIndex == iSelectedCar)
            ...
            menu_render_text(mr, 15, default_names[iFontWidth], font1_ascii,
                             font1_offsets, 430, iTextPosY, byTempValue, 0,
                             pal_addr);
          }
        } else {
          ...
          if (iCarIndex == iSelectedCar)
            ...
            byTextColor1 = 0x8B;
          menu_render_text(mr, 15, szCarName, font1_ascii, font1_offsets, 425,
                           iTextPosY, byTextColor1, 2u, pal_addr);
          if (iCarIndex == iSelectedCar)
          ...
          menu_render_text(mr, 15,
                           player_names[car_to_player[14 - (iCarLoop & 0xFE) +
                                                      (iCarLoop & 1)]],
                           font1_ascii, font1_offsets, 430, iTextPosY,
                           byTextColor2, 0, pal_addr);
        }
      ...
      if (player_type == 2) {
        if (iSelectedCar == 2 && iEditingName == 1) {
          ...
          if (iSelectedCar == player_type)
            ...
            byTextColor5 = 0x8F;
          menu_render_text(mr, 15, &config_buffer[4288], font1_ascii,
                           font1_offsets, 425, 338, byTextColor5, player_type,
                           pal_addr);
          if (iSelectedCar == 2)
            ...
            byTextColor6 = 0x8F;
          menu_render_text(mr, 15, szNewNameBuf, font1_ascii, font1_offsets,
                           430, 338, byTextColor6, 0, pal_addr);
        } else {
          ...
          iTemp1 = iSelectedCar;
          menu_render_text(mr, 15, &config_buffer[4288], font1_ascii,
                           font1_offsets, 425, 338, byTextColor7, 2u, pal_addr);
          if (iTemp1 == 2)
            byTextColor8 = iHighlightColor;
          else
            byTextColor8 = 0x8F;
          menu_render_text(mr, 15, player_names[player2_car], font1_ascii,
                           font1_offsets, 430, 338, byTextColor8, 0, pal_addr);
        }
      }
      ...
      if (iSelectedCar == 1 && iEditingName == 1) {
        ...
        menu_render_text(mr, 15, &config_buffer[4224], font1_ascii,
                         font1_offsets, 425, 356, iNormalColor, 2u, pal_addr);
        if (iSelectedCar == 1)
          byTextColor9 = iHighlightColor;
        else
          byTextColor9 = 0x8F;
        menu_render_text(mr, 15, szNewNameBuf, font1_ascii, font1_offsets, 430,
                         356, byTextColor9, 0, pal_addr);
      } else {
        ...
        menu_render_text(mr, 15, &config_buffer[4224], font1_ascii,
                         font1_offsets, 425, 356, byColor, 2u, pal_addr);
        if (iSelectedCar_1 == 1)
          byColor_1 = iHighlightColor;
        else
          byColor_1 = 0x8F;
        menu_render_text(mr, 15, player_names[player1_car], font1_ascii,
                         font1_offsets, 430, 356, byColor_1, 0, pal_addr);
      }
      ...
      menu_render_text(mr, 15, &config_buffer[832], font1_ascii, font1_offsets,
                       420, 374, byColor_2, 2u, pal_addr);

      // Display blinking cursor when editing names
      if (iEditingName == 1) {
        if ((frames & 0xFu) < 8) // blink cursor based on frame counter
          menu_render_text(mr, 15, "_", font1_ascii, font1_offsets, iTextPosX,
                           iY, 0xABu, 0, pal_addr);
    ...
    case 1:
      ...
      if (iVolumeSelection == 1)
        ...
        byVolumeColor1 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2304], font1_ascii,
                              font1_offsets, 425, 80, byVolumeColor1, 2u, 200,
                              640, pal_addr);
      ...
      if (iVolumeSelection == 2)
        ...
        byVolumeColor2 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2368], font1_ascii,
                              font1_offsets, 425, 104, byVolumeColor2, 2u, 200,
                              640, pal_addr);
      ...
      if (iVolumeSelection == 3)
        ...
        byVolumeColor3 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2432], font1_ascii,
                              font1_offsets, 425, 128, byVolumeColor3, 2u, 200,
                              640, pal_addr);
      ...
      if (iVolumeSelection == 4)
        ...
        byVolumeColor4 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2496], font1_ascii,
                              font1_offsets, 425, 152, byVolumeColor4, 2u, 200,
                              640, pal_addr);
      ...
      if (iVolumeSelection == 5)
        ...
        byColor_3 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2560], font1_ascii,
                              font1_offsets, 425, 176, byColor_3, 2u, 200, 640,
                              pal_addr);
      if (allengines) {
        if (iVolumeSelection == 5)
          byColor_4 = 0xAB;
          ...
          byColor_4 = 0x8F;
        // ALL ENGINES
        menu_render_scaled_text(mr, 15, &config_buffer[2752], font1_ascii,
                                font1_offsets, 430, 176, byColor_4, 0, 200, 640,
                                pal_addr);
      } else {
        if (iVolumeSelection == 5)
          byColor_5 = 0xAB;
          ...
          byColor_5 = 0x8F;
        // STARTERS & TURBOS
        menu_render_scaled_text(mr, 15, &config_buffer[2816], font1_ascii,
                                font1_offsets, 430, 176, byColor_5, 0, 200, 640,
                                pal_addr);
      }
      ...
      if (iVolumeSelection == 6)
        ...
        byColor_6 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2880], font1_ascii,
                              font1_offsets, 425, 200, byColor_6, 2u, 200, 640,
                              pal_addr);
      if (soundon) {
        if (iVolumeSelection == 6)
          byColor_7 = 0xAB;
          ...
          byColor_7 = 0x8F;
        // ON
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 430, 200, byColor_7, 0, 200, 640,
                                pal_addr);
      } else if (SoundCard) {
        if (iVolumeSelection == 6)
          byColor_8 = 0xAB;
          ...
          byColor_8 = 0x8F;
        // OFF
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 430, 200, byColor_8, soundon,
                                200, 640, pal_addr);
      } else {
        if (iVolumeSelection == 6)
          byColor_9 = 0xAB;
        ...
        menu_render_scaled_text(mr, 15, &config_buffer[6848], font1_ascii,
                                font1_offsets, 430, 200, byColor_9, soundon,
                                200, 640, pal_addr);
      }
      ...
      if (iVolumeSelection == 7)
        ...
        byColor_10 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[2944], font1_ascii,
                              font1_offsets, 425, 224, byColor_10, 2u, 200, 640,
                              pal_addr);
      if (musicon) {
        if (iVolumeSelection == 7)
          byColor_11 = 0xAB;
        ...
        // ON
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 430, 224, byColor_11, 0, 200,
                                640, pal_addr);
        ...
        // OFF
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 430, 224, byColor_12, 0, 200,
                                640, pal_addr);
      } else {
        if (iVolumeSelection == 7)
          byColor_13 = 0xAB;
        ...
        // DISABLED
        menu_render_scaled_text(mr, 15, &config_buffer[6848], font1_ascii,
                                font1_offsets, 430, 224, byColor_13, musicon,
                                200, 640, pal_addr);
      }
      ...
      if (iVolumeSelection)
        ...
        byColor_14 = 0xAB;
      menu_render_scaled_text(mr, 15, &config_buffer[832], font1_ascii,
                              font1_offsets, 420, 248, byColor_14, 2u, 200, 640,
                              pal_addr);
    ...
    case 2:
      ...
      if (iConfigState == 3) {
        ...
        menu_render_scaled_text(mr, 15, &config_buffer[2112], font1_ascii,
                                font1_offsets, 400, 60, 143, 1u, 200, 640,
                                pal_addr);
        // THEN PRESS ANY KEY
        menu_render_scaled_text(mr, 15, &config_buffer[2176], font1_ascii,
                                font1_offsets, 400, 78, 143, 1u, 200, 640,
                                pal_addr);
      }
      ...
      // X1 axis display
      menu_render_scaled_text(mr, 15, &config_buffer[1728], font1_ascii,
                              font1_offsets, 400, 110, 143, 1u, 200, 640,
                              pal_addr);
      if (iConfigState_1 == 3) {
        ...
        menu_render_scaled_text(mr, 15, szJoyStatus1, font1_ascii,
                                font1_offsets, 400, 128, 143, 1u, 200, 640,
                                pal_addr);
      }

      // Y1 axis display
      menu_render_scaled_text(mr, 15, &config_buffer[1792], font1_ascii,
                              font1_offsets, 400, 160, 143, 1u, 200, 640,
                              pal_addr);
      if (iConfigState == 3) {
        // Show Calibration bar
        ...
        menu_render_scaled_text(mr, 15, szJoyStatus2, font1_ascii,
                                font1_offsets, 400, 178, 143, 1u, 200, 640,
                                pal_addr);
      }

      // X2 axis display
      menu_render_scaled_text(mr, 15, &config_buffer[1856], font1_ascii,
                              font1_offsets, 400, 210, 143, 1u, 200, 640,
                              pal_addr);
      if (iConfigState == 3) {
        // Calibration bar
        ...
        menu_render_scaled_text(mr, 15, szX2Text, font1_ascii, font1_offsets,
                                400, 228, 143, 1u, 200, 640, pal_addr);
      }

      iConfigState_2 = iConfigState;

      // Y2 axis display
      menu_render_scaled_text(mr, 15, &config_buffer[1920], font1_ascii,
                              font1_offsets, 400, 260, 143, 1u, 200, 640,
                              pal_addr);
      if (iConfigState_2 == 3) {
        // Calibration bar
        ...
        menu_render_scaled_text(mr, 15, szY2Text, font1_ascii, font1_offsets,
                                400, 278, 143, 1u, 200, 640, pal_addr);
      }
      goto RENDER_FRAME;
    case 3:
      ...
      if (player_type == 2) {
        ...
        if (iControlSelection == 4)
          ...
          byColor_19 = 0x8F;
        menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 420,
                                60, byColor_19, 1u, 200, 640, pal_addr);
        ...
        if (iControlSelection == 3)
          ...
          byColor_20 = 0x8F;
        // CUSTOMIZE PLAYER 2
        menu_render_scaled_text(mr, 15, &config_buffer[704], font1_ascii,
                                font1_offsets, 420, 78, byColor_20, 1u, 200,
                                640, pal_addr);
      }
      ...
      if (iControlSelection == 2)
        ...
        byColor_21 = 0x8F;
      menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 420,
                              96, byColor_21, 1u, 200, 640, pal_addr);
      ...
      if (iControlSelection == 1)
        ...
        byColor_22 = 0x8F;
      // CUSTOMIZE PLAYER 1
      menu_render_scaled_text(mr, 15, &config_buffer[768], font1_ascii,
                              font1_offsets, 420, 114, byColor_22, 1u, 200, 640,
                              pal_addr);
      ...
      if (iControlSelection)
        ...
        byColor_23 = 0xAB;
      menu_render_scaled_text(mr, 15, &config_buffer[832], font1_ascii,
                              font1_offsets, 420, 132, byColor_23, 1u, 200, 640,
                              pal_addr);
      ...
      if (iControlSelection == 1 || iControlSelection == 2) {
        ...
        do {
          if (iControlLoop == control_edit)
            ...
            byControlColor = 0x8F;
          menu_render_text(mr, 15, szControlName, font1_ascii, font1_offsets,
                           475, iY_1, byControlColor, 2u, pal_addr);
          if (iControlLoop == control_edit)
            byColor_24 = 0xAB;
          else
            byColor_24 = 0x8F;
          menu_render_scaled_text(mr, 15, keyname[userkey[iControlLoop]],
                                  font1_ascii, font1_offsets, 480, iY_1,
                                  byColor_24, 0, 200, 640, pal_addr);
        ...
        if (Players_Cars[player1_car] >= 8) {
          if (control_edit == 12)
            ...
            byColor_25 = 0x8F;
          menu_render_text(mr, 15, "CHEAT:", font1_ascii, font1_offsets, 475,
                           308, byColor_25, 2u, pal_addr);
          if (control_edit == 12)
            byColor_26 = 0xAB;
          else
            byColor_26 = 0x8F;
          menu_render_scaled_text(mr, 15, keyname[userkey[12]], font1_ascii,
                                  font1_offsets, 480, 308, byColor_26, 0, 200,
                                  640, pal_addr);
        }
      }
      // Display Player 2 control customization screen
        ...
        do {
          if (iControlIndex2 == control_edit)
            ...
            byColor_27 = 0x8F;
          menu_render_text(mr, 15, szText, font1_ascii, font1_offsets, 475,
                           iY_2, byColor_27, 2u, pal_addr);
          if (iControlIndex2 == control_edit)
            byColor_28 = 0xAB;
          else
            byColor_28 = 0x8F;
          menu_render_text(mr, 15, keyname[userkey[iControlIndex2]],
                           font1_ascii, font1_offsets, 480, iY_2, byColor_28, 0,
                           pal_addr);
        ...
        if (Players_Cars[player2_car] >= 8) {
          if (control_edit == 13)
            ...
            byColor_29 = 0x8F;
          menu_render_text(mr, 15, "CHEAT:", font1_ascii, font1_offsets, 475,
                           308, byColor_29, 2u, pal_addr);
          if (control_edit == 13)
            byColor_30 = 0xAB;
          else
            byColor_30 = 0x8F;
          menu_render_text(mr, 15, keyname[userkey[13]], font1_ascii,
                           font1_offsets, 480, 308, byColor_30, 0, pal_addr);
        }
      }
      ...
      if (iFoundKey == -1) {
        if (y2ok) {
          iJoyValue1 =
              100 * (2 * joyPos.iJ2YAxis - JBYmax - JBYmin) / (JBYmax - JBYmin);
          if (iJoyValue1 < -50)
            iFoundKey = 138;
          if (iJoyValue1 > 50)
            iFoundKey = 139;
        ...
        if (x2ok) {
          iJoyValue2 =
              100 * (2 * joyPos.iJ2XAxis - JBXmax - JBXmin) / (JBXmax - JBXmin);
          if (iJoyValue2 < -50)
            iFoundKey = 136;
          if (iJoyValue2 > 50)
            iFoundKey = 137;
        ...
        if (y1ok) {
          iJoyValue3 =
              100 * (2 * joyPos.iJ1YAxis - JAYmax - JAYmin) / (JAYmax - JAYmin);
          if (iJoyValue3 < -50)
            iFoundKey = 134;
          if (iJoyValue3 > 50)
            iFoundKey = 135;
        ...
        if (x1ok) {
          iJoyValue4 =
              100 * (2 * joyPos.iJ1XAxis - JAXmax - JAXmin) / (JAXmax - JAXmin);
          if (iJoyValue4 < -50)
            iFoundKey = 132;
          if (iJoyValue4 > 50)
            iFoundKey = 133;
      ...
      //          && (userkey[control_edit] <= 0x83u && iFoundKey > 131 ||
      //          userkey[control_edit] > 0x83u && iFoundKey <= 131) ) {
      ////if (iFoundKey != -1
      ////  && (control_edit == 1 || control_edit == 7)
      ////  && (*((_BYTE *)&keyname[139] + control_edit + 3) <= 0x83u &&
      /// iFoundKey > 131 || *((_BYTE *)&keyname[139] + control_edit + 3) >
      /// 0x83u
      ///&& iFoundKey <= 131)) {
      //  iFoundKey = -1;                       // reject incompatible input
      //  type
      //}
    ...
    RENDER_FRAME:
      ...
      if (switch_same > 0) {
        ...
        if (players > 0) {
          ...
          //   ++iPlayerIdx;
          //   *(int *)((char *)&infinite_laps + iPlayersCarsOffset) =
          //   switch_same - 666;// offset into Players_Cars
        ...
        if (players > 0) {
          ...
          //   ++iPlayerIdx_1;
          //   *(int *)((char *)&infinite_laps + iPlayersCarsOffset_1) = -1;//
          //   offset into Players_Cars
          ...
          case 1: // DRIVER/CAR CONFIG
            ...
            HANDLE_CHAR_INPUT:
              if (iEditingName) {
                ...
                if ((iKeyChar == 32 || iKeyChar >= 65 && iKeyChar <= 90 ||
                     iKeyChar >= 48 && iKeyChar <= 57) &&
                    iNameLength < 8) {
              ...
              if (iEditingName) {
                ...
                if (iSelectedCar) {
                  if ((unsigned int)iSelectedCar <= 1) {
                    ...
                    // for (j = 0; j < 9; cheat_names[player1_car + 31][j + 8] =
                    // *((_BYTE *)&pJoyPos.iJ2YAxis + j + 3))
                    //   ++j;
                    ...
                    if (!network_on)
                      waste =
                          CheckNames(player_names[player1_car], player1_car);
                    check_cars();
                  } else {
                    if (iSelectedCar != 2)
                    ...
                    // for (k = 0; k < 9; cheat_names[iPlayer2Car + 31][k + 8] =
                    // *((_BYTE *)&pJoyPos.iJ2YAxis + k + 3))
                    //   ++k;
                ...
                SAVE_AI_DRIVER_NAME:
                  ...
                  iDefaultNamesIdx_1 =
                      (iSelectedCar - 3) ^ 1; // Toggle for paired AI drivers
                  // LOBYTE(iDefaultNamesIdx_1) = (iSelectedCar - 3) ^ 1;//
                  // Toggle for paired AI drivers
                  iDefaultNamesCharItr = 0;
                  iDefaultNamesIdx = iDefaultNamesIdx_1;

                  do {
                    default_names[iDefaultNamesIdx][iDefaultNamesCharItr] =
                        szNewNameBuf[iDefaultNamesCharItr];
                    ++iDefaultNamesCharItr;
                  } while (iDefaultNamesCharItr < 9);
                  // do {
                  //   ++iDefaultNamesCharItr;
                  //   *((_BYTE *)&team_col[15] + iDefaultNamesCharItr +
                  //   iDefaultNamesIdx * 9 + 3) = *((_BYTE *)&pJoyPos.iJ2YAxis
                  //   + iDefaultNamesCharItr + 3);// offset into default_names
                  // } while (iDefaultNamesCharItr < 9);
                ...
                if (iEditingName == 1) {
                  ...
                  if ((unsigned int)iSelectedCar <= 1) // Load player 1 name
                  {
                    ...
                    // for (m = 0; m < 9; *((_BYTE *)&pJoyPos.iJ2YAxis + m + 3)
                    // = cheat_names[player1_car + 31][m + 8])
                    //   ++m;
                  } else if (iSelectedCar == 2) // Load player 2 name
                  {
                    ...
                    // for (n = 0; n < 9; *((_BYTE *)&pJoyPos.iJ2YAxis + n + 3)
                    // = cheat_names[player2_car + 31][n + 8])
                    //   ++n;
              ...
              if (iEditingName) {
                ...
                if (iSelectedCar) {
                  if ((unsigned int)iSelectedCar <= 1) // player 1
                  {
                    ...
                    // for (ii = 0; ii < 9; cheat_names[player1_car + 31][ii +
                    // 8] = *((_BYTE *)&pJoyPos.iJ2YAxis + ii + 3))
                    //   ++ii;
                    broadcast_mode = -669;
                    while (broadcast_mode)
                      UpdateSDL();
                    ...
                    // for (jj = 0; jj < 9; cheat_names[iPlayer2Car_1 + 31][jj +
                    // 8] = *((_BYTE *)&pJoyPos.iJ2YAxis + jj + 3))
                    //   ++jj;
                    waste =
                        CheckNames(player_names[iPlayer2Car_1], iPlayer2Car_1);
                  }
                } else // AI driver
                {
                CANCEL_AI_NAME_EDIT:
                  ...
                  // do {
                  //   ++v196;
                  //   *((_BYTE *)&team_col[15] + v196 + v197 * 9 + 3) =
                  //   *((_BYTE *)&pJoyPos.iJ2YAxis + v196 + 3);
                  // } while (v196 < 9);
              ...
              if (!uiKey_5) // Extended key
              {
                ...
                case 0x4B: // Left arrow - decrease volume
                  ...
                  case 4: // Music volume
                    ...
                    if (MusicCD)
                      goto SET_CD_VOLUME; // CONTINUE_AUDIO_INPUT: Continue
                                          // processing audio menu input
                    break;
                  default:
                    continue;
                  }
            ...
            if (uiKey_1 < 0xD) {
              if (!uiKey_1) // Extended key
              {
                ...
                if (uiKey_6 >= 0x48) {
                  ...
                  } else if (uiKey_6 == 80 && !iControlsInEdit &&
                             --iControlSelection < 0) {
                ...
                LABEL_1028:
                  if (iEditingName && iNameLength < 13) {
                    if (iGameIndex >= 97 && iGameIndex <= 122)
                      iGameIndex -= 32;
                    if (iGameIndex >= 65 && iGameIndex <= 90 ||
                        iGameIndex >= 48 && iGameIndex <= 57 ||
                        iGameIndex == 32 || iGameIndex == 46 ||
                        iGameIndex == 39) {
                      iResultValue = 14 * (4 - iNetworkState);
                      iCalculation = iNameLength + 1;
                      network_messages[0][iNameLength + iResultValue] =
                          iGameIndex;
    ...
    case 4:
      ...
      if (iVideoState == 16)
        ...
        byColor_31 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[6912], font1_ascii,
                              font1_offsets, 435, 60, byColor_31, 2u, 200, 640,
                              pal_addr);
      ...
      menu_render_scaled_text(mr, 15, szText_1, font1_ascii, font1_offsets, 440,
                              60, byTempChar1, 0, 200, 640, pal_addr);
      sprintf(buffer, "%s:", &config_buffer[3968]);
      if (iVideoState == 15)
        byColor_34 = 0xAB;
      else
        byColor_34 = 0x8F;
      menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 435,
                              80, byColor_34, 2u, 200, 640, pal_addr);
      if (names_on) {
        if (names_on == 2) {
          if (iVideoState == 15)
            byColor_105 = 0xAB;
            ...
            byColor_105 = 0x8F;
          menu_render_scaled_text(mr, 15, &config_buffer[2816], font1_ascii,
                                  font1_offsets, 440, 80, byColor_105, 0, 200,
                                  640, pal_addr);
        } else {
          if (iVideoState == 15)
            byColor_35 = 0xAB;
            ...
            byColor_35 = 0x8F;
          menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                  font1_offsets, 440, 80, byColor_35, 0, 200,
                                  640, pal_addr);
        }
      } else {
        if (iVideoState == 15)
          ...
          byColor_36 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 80, byColor_36, 0, 200, 640,
                                pal_addr);
      }
      if (iVideoState == 14)
        byColor_37 = 0xAB;
        ...
        byColor_37 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3008], font1_ascii,
                              font1_offsets, 435, 100, byColor_37, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_BUILDINGS) != 0) {
        if (iVideoState == 14)
          ...
          byColor_38 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 100, byColor_38, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 14)
          byColor_39 = 0xAB;
          ...
          byColor_39 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 100, byColor_39, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 13)
        byColor_40 = 0xAB;
        ...
        byColor_40 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3072], font1_ascii,
                              font1_offsets, 435, 120, byColor_40, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_GLASS_WALLS) != 0) {
        if (iVideoState == 13)
          ...
          byColor_41 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 120, byColor_41, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 13)
          byColor_42 = 0xAB;
          ...
          byColor_42 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 120, byColor_42, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 12)
        byColor_43 = 0xAB;
        ...
        byColor_43 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3200], font1_ascii,
                              font1_offsets, 435, 140, byColor_43, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_HORIZON) != 0) {
        if (iVideoState == 12)
          ...
          byColor_44 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 140, byColor_44, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 12)
          byColor_45 = 0xAB;
          ...
          byColor_45 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 140, byColor_45, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 11)
        byColor_46 = 0xAB;
        ...
        byColor_46 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3136], font1_ascii,
                              font1_offsets, 435, 160, byColor_46, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_CAR_TEXTURES) != 0) {
        if (iVideoState == 11)
          ...
          byColor_47 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 160, byColor_47, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 11)
          byColor_48 = 0xAB;
          ...
          byColor_48 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 160, byColor_48, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 10)
        byColor_49 = 0xAB;
        ...
        byColor_49 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3264], font1_ascii,
                              font1_offsets, 435, 180, byColor_49, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_WALL_TEXTURES) != 0) {
        if (iVideoState == 10)
          ...
          byColor_50 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 180, byColor_50, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 10)
          byColor_51 = 0xAB;
          ...
          byColor_51 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 180, byColor_51, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 9)
        byColor_52 = 0xAB;
        ...
        byColor_52 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3328], font1_ascii,
                              font1_offsets, 435, 200, byColor_52, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_GROUND_TEXTURES) != 0) {
        if (iVideoState == 9)
          ...
          byColor_53 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 200, byColor_53, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 9)
          byColor_54 = 0xAB;
          ...
          byColor_54 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 200, byColor_54, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 8)
        byColor_55 = 0xAB;
        ...
        byColor_55 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3392], font1_ascii,
                              font1_offsets, 435, 220, byColor_55, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_BUILDING_TEXTURES) == 0) {
        if (iVideoState == 8)
          ...
          byColor_56 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 220, byColor_56, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 8)
          byColor_57 = 0xAB;
          ...
          byColor_57 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 220, byColor_57, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 7)
        byColor_58 = 0xAB;
        ...
        byColor_58 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3456], font1_ascii,
                              font1_offsets, 435, 240, byColor_58, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_ROAD_TEXTURES) != 0) {
        if (iVideoState == 7)
          ...
          byColor_59 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 240, byColor_59, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 7)
          byColor_60 = 0xAB;
          ...
          byColor_60 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 240, byColor_60, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 6)
        byColor_61 = 0xAB;
        ...
        byColor_61 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3520], font1_ascii,
                              font1_offsets, 435, 260, byColor_61, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_SHADOWS) != 0) {
        if (iVideoState == 6)
          ...
          byColor_62 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 260, byColor_62, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 6)
          byColor_63 = 0xAB;
          ...
          byColor_63 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 260, byColor_63, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 5)
        byColor_64 = 0xAB;
        ...
        byColor_64 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3584], font1_ascii,
                              font1_offsets, 435, 280, byColor_64, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_CLOUDS) != 0) {
        if (iVideoState == 5)
          ...
          byColor_65 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 280, byColor_65, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 5)
          byColor_66 = 0xAB;
          ...
          byColor_66 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 280, byColor_66, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 4)
        byColor_67 = 0xAB;
        ...
        byColor_67 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3648], font1_ascii,
                              font1_offsets, 435, 300, byColor_67, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_PANEL_OFF) != 0) {
        if (iVideoState == 4)
          byColor_68 = 0xAB;
          ...
          byColor_68 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 300, byColor_68, 0, 200,
                                640, pal_addr);
      } else if ((textures_off & TEX_OFF_PANEL_RESTRICTED) != 0) {
        if (iVideoState == 4)
          byColor_69 = 0xAB;
          ...
          byColor_69 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[3776], font1_ascii,
                                font1_offsets, 440, 300, byColor_69, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 4)
          byColor_70 = 0xAB;
          ...
          byColor_70 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 300, byColor_70, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 3)
        byColor_71 = 0xAB;
        ...
        byColor_71 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3712], font1_ascii,
                              font1_offsets, 435, 320, byColor_71, 2u, 200, 640,
                              pal_addr);
      if (view_limit) {
        if (iVideoState == 3)
          byColor_72 = 0xAB;
          ...
          byColor_72 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[3776], font1_ascii,
                                font1_offsets, 440, 320, byColor_72, 0, 200,
                                640, pal_addr);
      } else {
        if (iVideoState == 3)
          byColor_73 = 0xAB;
          ...
          byColor_73 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[3840], font1_ascii,
                                font1_offsets, 440, 320, byColor_73, 0, 200,
                                640, pal_addr);
      }
      if (iVideoState == 2)
        byColor_74 = 0xAB;
        ...
        byColor_74 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[3904], font1_ascii,
                              font1_offsets, 435, 340, byColor_74, 2u, 200, 640,
                              pal_addr);
      if (game_svga)
        iReturnValue = (100 * game_size) >> 7;
      // iReturnValue = (100 * game_size) % 128;
      // iReturnValue = (100 * game_size - (__CFSHL__((100 * game_size) >> 31,
      // 7) + ((100 * game_size) >> 31 << 7))) >> 7;
      else
        iReturnValue = (100 * game_size) >> 6;
      // iReturnValue = (100 * game_size) % 64;
      // iReturnValue = (100 * game_size - (__CFSHL__((100 * game_size) >> 31,
      // 6) + ((100 * game_size) >> 31 << 6))) >> 6;
      sprintf(buffer, "%i %%", iReturnValue);
      if (iVideoState == 2)
        byColor_76 = 0xAB;
      else
        byColor_76 = 0x8F;
      menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 440,
                              340, byColor_76, 0, 200, 640, pal_addr);
      if (game_svga) {
        if (iVideoState == 1)
          byColor_75 = 0xAB;
        else
          byColor_75 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[512], font1_ascii,
                                font1_offsets, 440, 360, byColor_75, 1u, 20,
                                640, pal_addr);
      } else {
        if (iVideoState == 1)
          byColor_77 = 0xAB;
          ...
          byColor_77 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[448], font1_ascii,
                                font1_offsets, 440, 360, byColor_77, 1u, 200,
                                640, pal_addr);
      }
      if (iVideoState)
        byColor_78 = 0x8F;
        ...
        byColor_78 = 0xAB;
      menu_render_scaled_text(mr, 15, &config_buffer[832], font1_ascii,
                              font1_offsets, 430, 380, byColor_78, 2u, 200, 640,
                              pal_addr);
      goto RENDER_FRAME;
    case 5:
      if (iConfigState != 6)
      ...
      if (player_type == 2) {
        ...
        if (iGraphicsState == 6)
          ...
          byColor_79 = 0x8F;
        menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 435,
                                78, byColor_79, 2u, 200, 640, pal_addr);
        if (iGraphicsState == 6)
          byColor_80 = 0xAB;
        else
          byColor_80 = 0x8F;
        menu_render_scaled_text(
            mr, 15, &config_buffer[64 * game_view[1] + 4928], font1_ascii,
            font1_offsets, 440, 78, byColor_80, 0, 200, 640, pal_addr);
      }
      ...
      if (iGraphicsState == 5)
        ...
        byColor_81 = 0x8F;
      menu_render_scaled_text(mr, 15, buffer, font1_ascii, font1_offsets, 435,
                              96, byColor_81, 2u, 200, 640, pal_addr);
      if (iGraphicsState == 5)
        byColor_82 = 0xAB;
      else
        byColor_82 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[64 * game_view[0] + 4928],
                              font1_ascii, font1_offsets, 440, 96, byColor_82,
                              0, 200, 640, pal_addr);
      if (iGraphicsState == 4)
        byColor_83 = 0xAB;
      else
        byColor_83 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[5440], font1_ascii,
                              font1_offsets, 435, 114, byColor_83, 2u, 200, 640,
                              pal_addr);
      if ((textures_off & TEX_OFF_KMH) != 0) {
        if (iGraphicsState == 4)
          ...
          byColor_84 = 0x8F;
        menu_render_scaled_text(mr, 15, "KMH", font1_ascii, font1_offsets, 440,
                                114, byColor_84, 0, 200, 640, pal_addr);
      } else {
        if (iGraphicsState == 4)
          byColor_85 = 0xAB;
        else
          byColor_85 = 0x8F;
        menu_render_scaled_text(mr, 15, "MPH", font1_ascii, font1_offsets, 440,
                                114, byColor_85, 0, 200, 640, pal_addr);
      }
      if (iGraphicsState == 3)
        byColor_86 = 0xAB;
      else
        byColor_86 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[5504], font1_ascii,
                              font1_offsets, 435, 132, byColor_86, 2u, 200, 640,
                              pal_addr);
      if (replay_record) {
        if (iGraphicsState == 3)
          byColor_87 = 0xAB;
          ...
          byColor_87 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 132, byColor_87, 0, 200,
                                640, pal_addr);
      } else {
        if (iGraphicsState == 3)
          byColor_88 = 0xAB;
          ...
          byColor_88 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 132, byColor_88, 0, 200,
                                640, pal_addr);
      }
      if (iGraphicsState == 2)
        byColor_89 = 0xAB;
        ...
        byColor_89 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[4672], font1_ascii,
                              font1_offsets, 435, 150, byColor_89, 2u, 200, 640,
                              pal_addr);
      if (p_tex_size == 1) {
        if (iGraphicsState == 2)
          byColor_90 = 0xAB;
          ...
          byColor_90 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[4736], font1_ascii,
                                font1_offsets, 440, 150, byColor_90, 0, 200,
                                640, pal_addr);
      } else {
        if (iGraphicsState == 2)
          byColor_91 = 0xAB;
          ...
          byColor_91 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[4800], font1_ascii,
                                font1_offsets, 440, 150, byColor_91, 0, 200,
                                640, pal_addr);
      }
      if (iGraphicsState == 1)
        byColor_92 = 0xAB;
        ...
        byColor_92 = 0x8F;
      menu_render_scaled_text(mr, 15, &config_buffer[5888], font1_ascii,
                              font1_offsets, 435, 168, byColor_92, 2u, 200, 640,
                              pal_addr);
      if (false_starts) {
        if (iGraphicsState == 1)
          byColor_93 = 0xAB;
          ...
          byColor_93 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2624], font1_ascii,
                                font1_offsets, 440, 168, byColor_93, 0, 200,
                                640, pal_addr);
      } else {
        if (iGraphicsState == 1)
          byColor_94 = 0xAB;
          ...
          byColor_94 = 0x8F;
        menu_render_scaled_text(mr, 15, &config_buffer[2688], font1_ascii,
                                font1_offsets, 440, 168, byColor_94, 0, 200,
                                640, pal_addr);
      }
      if (iGraphicsState)
        byColor_95 = 0x8F;
        ...
        byColor_95 = 0xAB;
      menu_render_scaled_text(mr, 15, &config_buffer[832], font1_ascii,
                              font1_offsets, 430, 186, byColor_95, 2u, 200, 640,
                              pal_addr);
      goto RENDER_FRAME;
    case 6:
      if (iEditingName == 1) {
      ...
      if (iEditingName == 1) {
        iTextPosX = 0;
        for (szMemPtr = network_messages[4 - iNetworkState]; *szMemPtr;
             ++szMemPtr) {
      ...
      if (iNetworkState == 5)
        ...
        byColor_106 = 0x8F;
      menu_render_text(mr, 15, &language_buffer[7296], font1_ascii,
                       font1_offsets, 390, 50, byColor_106, 1u, pal_addr);
      if (iNetworkState == 4)
        byColor_98 = byColor_97;
      else
        byColor_98 = 0x8F;
      menu_render_text(mr, 15, &config_buffer[5632], font1_ascii, font1_offsets,
                       385, 68, byColor_98, 2u, pal_addr);
      if (iNetworkState == 4)
        byColor_99 = byColor_96;
      else
        byColor_99 = 0x8F;
      menu_render_scaled_text(mr, 15, network_messages[0], font1_ascii,
                              font1_offsets, 390, 68, byColor_99, 0, 200, 630,
                              pal_addr);
      if (iNetworkState == 3)
        byColor_100 = byColor_97;
      else
        byColor_100 = 0x8F;
      menu_render_text(mr, 15, &config_buffer[5696], font1_ascii, font1_offsets,
                       385, 86, byColor_100, 2u, pal_addr);
      if (iNetworkState == 3)
        byColor_101 = byColor_96;
      else
        byColor_101 = 0x8F;
      menu_render_scaled_text(mr, 15, network_messages[1], font1_ascii,
                              font1_offsets, 390, 86, byColor_101, 0, 200, 630,
                              pal_addr);
      if (iNetworkState == 2)
        byColor_102 = byColor_97;
      else
        byColor_102 = 0x8F;
      menu_render_text(mr, 15, &config_buffer[5760], font1_ascii, font1_offsets,
                       385, 104, byColor_102, 2u, pal_addr);
      if (iNetworkState == 2)
        byColor_103 = byColor_96;
      else
        byColor_103 = 0x8F;
      menu_render_scaled_text(mr, 15, network_messages[2], font1_ascii,
                              font1_offsets, 390, 104, byColor_103, 0, 200, 630,
                              pal_addr);
      if (iNetworkState == 1)
        byColor_104 = byColor_97;
      else
        byColor_104 = 0x8F;
      menu_render_text(mr, 15, &config_buffer[5824], font1_ascii, font1_offsets,
                       385, 122, byColor_104, 2u, pal_addr);
      if (iNetworkState != 1)
        byColor_96 = 0x8F;
      byTempChar2 = byColor_96;
      iNetworkState_1 = iNetworkState;
      menu_render_scaled_text(mr, 15, network_messages[3], font1_ascii,
                              font1_offsets, 390, 122, byTempChar2, 0, 200, 630,
                              pal_addr);
      if (iNetworkState_1)
        byColor_97 = 0x8F;
      menu_render_text(mr, 15, &config_buffer[832], font1_ascii, font1_offsets,
                       390, 140, byColor_97, 1u, pal_addr);
      if (iEditingName == 1 && (frames & 0xFu) < 8) {
        iX = stringwidth(network_messages[4 - iNetworkState]) + 390;
        if (iX <= 620)
          menu_render_text(mr, 15, "_", font1_ascii, font1_offsets, iX, iY,
                           0xABu, 0, pal_addr);
        else
          menu_render_text(mr, 15, "_", font1_ascii, font1_offsets, 621, iY,
                           0xABu, 0, pal_addr);
      }
      goto RENDER_FRAME;
    default:
...
void front_volumebar(int iY, int iVolumeLevel, int iFillColor) {
  ...
  pbyScreenPos =
      &scrbuf[winw * iY + 430]; // Calculate starting position in screen buffer
                                // (430 pixels from left edge)
  ...
  { // Skip first and last row (draw border on those)
    if (iRow && iRow != 16) {
      *pbyScreenPos = 0x8F; // Draw left border (0x8F is white in PALETTE.PAL)
      memset(pbyScreenPos + 1, iFillColor,
             160 * iVolumeLevel / 127); // Fill volume bar based on level (160 *
                                        // volume / 127 pixels wide)
      iScreenWidth = winw;
      pbyScreenPos[161] =
          0x8F; // Draw right border  (0x8F is white in PALETTE.PAL)
      pbyScreenPos += iScreenWidth;
    } else {
      memset(pbyScreenPos, 0x8F, 0xA2u); // Draw top/bottom border - fill entire
                                         // width (162 pixels) with border color
      pbyScreenPos += winw;
    }
  }
}
